...
do
	...
	do
        ...
        samtools view -s 0.5 -@ 4 -o /scratch/aubkbk001/roh_param_project/04_subsample/output/i5_genome_downs.bam /scratch/aubkbk001/roh_param_project/03_read_align/output/sorted_bam/i5_genome_sorted.bam
	done
done
